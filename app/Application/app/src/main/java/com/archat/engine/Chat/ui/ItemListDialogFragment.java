...
public class ItemListDialogFragment extends BottomSheetDialogFragment {
    ...
    // Arraylist that will contain options for bottom sheet
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        DividerItemDecoration itemDecor = new DividerItemDecoration(recyclerView.getContext(), HORIZONTAL);
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            image = (ImageView) itemView.findViewById(R.id.optionImage);
    ...
    private class ItemAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            holder.text.setText(textOptions.get(position));
            holder.image.setImageResource(imageOptions.get(position));
        }
